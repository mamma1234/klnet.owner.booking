...
export default function CustomTable(props) {
  ...
  const { tableHead, tableData, tableHeaderColor,...state } = props;
          ...
          {tableData.length >=1?
            ...
            return (
              <TableRow key={key+index} style={{borderBottom:'1px solid',borderColor:'#dddddd'}} >
              	...
              	<TableCell style={{textAlignLast:'center',paddingTop:'3px',paddingBottom:'3px',borderRight:'1px solid silver'}}> {prop.view_activity}
              	<ActListIcon style={{color:'#00acc1',verticalAlign:'bottom'}} onClick={(event)=>handleClick(event,index)}/></TableCell>
              </TableRow>
            );
          })
          :<TableRow style={{borderBottom:'1px solid',borderColor:'#dddddd'}} >
        	<TableCell style={{textAlignLast:'center',paddingTop:'5px',paddingBottom:'5px',borderLeft:'1px solid silver',borderRight:'1px solid silver'}} colSpan="3">NO DATA</TableCell>
        	</TableRow>
      	  }
        </TableBody>
      </Table>
