  ...
  return (
    <GridContainer>
      ...
      <GridItem xs={12} sm={4}>
        <CustomInput
          validtype="english"
          success={trans.trans_code?true:false}
          error={trans.trans_code?false:true}
          labelText=""
          maxLength="10"
          id="trans_code"
          formControlProps={{
          ...
          inputProps={{
            value:trans.trans_code?trans.trans_code:'',
            onChange: (e)=>fncOnChange(e),
            onBlur: ()=>props.fncOnBlurParent(trans),
            endAdornment:
              <InputAdornment position="end">
                {/* <IconButton onClick={(e)=>{setOpenHsCode(true); setHsAnchorEl(hsAnchorEl?null:e.currentTarget)}}>
                  <Search />
                </IconButton> */}
                <TransPop
                  lineCode={trans.line_code}
                  fncTransPort={fncTransPort}
                  // {...props}
                />
              </InputAdornment>
          }}
