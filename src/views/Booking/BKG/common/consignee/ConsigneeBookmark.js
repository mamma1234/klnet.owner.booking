...
const ConsigneeBookmark = (props) => {
  ...
  useEffect(()=>{
    setConsignee({
      ...consignee,
      ['consignee_bookmark_seq']: props.booking?props.booking.consignee_bookmark_seq:null,
      ['consignee_bookmark_name']: props.booking?props.booking.consignee_bookmark_name:null,
      ['cons_name1']: props.booking?props.booking.cons_name1:null,
      ['cons_name2']: props.booking?props.booking.cons_name2:null,
      ['cons_code']: props.booking?props.booking.cons_code:null,
      ['cons_user_email']: props.booking?props.booking.cons_user_email:null,
      ['cons_user_fax']: props.booking?props.booking.cons_user_fax:null,
      ['cons_user_name']: props.booking?props.booking.cons_user_name:null,
      ['cons_user_tel']: props.booking?props.booking.cons_user_tel:null,
      ['cons_user_dept']: props.booking?props.booking.cons_user_dept:null,
      ['cons_address1']: props.booking?props.booking.cons_address1:null,
      ['cons_address2']: props.booking?props.booking.cons_address2:null,
      ['cons_address3']: props.booking?props.booking.cons_address3:null,
      ['cons_address4']: props.booking?props.booking.cons_address4:null,
      ['cons_address5']: props.booking?props.booking.cons_address5:null,
    })
  },[props.booking])
