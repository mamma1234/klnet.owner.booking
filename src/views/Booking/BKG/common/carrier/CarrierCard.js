    ...
    if( option ) {
      if( 'line_bookmark_seq' === code) {
          bookingStore.setBooking({
            ...
            'line_name1':option.line_name1?option.line_name1:bookingStore.booking.line_name1,
            'line_name2':option.line_name1?option.line_name2:bookingStore.booking.line_name2,
            'line_code':option.line_code?option.line_code:bookingStore.booking.line_code,
            'line_user_email':option.line_user_email?option.line_user_email:bookingStore.booking.line_user_email,
            'line_user_fax':option.line_user_fax?option.line_user_fax:bookingStore.booking.line_user_fax,
            'line_user_name':option.line_user_name?option.line_user_name:bookingStore.booking.line_user_name,
            'line_user_tel':option.line_user_tel?option.line_user_tel:bookingStore.booking.line_user_tel,
            'line_user_dept':option.line_user_dept?option.line_user_dept:bookingStore.booking.line_user_dept,
            'line_address1':option.line_address1?option.line_address1:bookingStore.booking.line_address1,
            'line_address2':option.line_address1?option.line_address2:bookingStore.booking.line_address2,
            'line_address3':option.line_address1?option.line_address3:bookingStore.booking.line_address3,
            'line_address4':option.line_address1?option.line_address4:bookingStore.booking.line_address4,
            'line_address5':option.line_address1?option.line_address5:bookingStore.booking.line_address5,
            'selected_yn':'Y'
          });
      }
    } else {
      if( bookingStore.booking.line_bookmark_seq ) {
        bookingStore.setBooking({
          ...bookingStore.booking,
