...
import { Card, Dialog, DialogActions, DialogContent, DialogTitle, IconButton, Divider, Avatar, CardHeader, TextField, FormLabel
            ...
            >
                ...
                >
                    ...
                    <h4 className={classes.modalTitle}>
                        <Bookmarks fontSize={'default'} style={{marginRight: '20px'}}/>
                        전체 북마크
                    </h4>
                </DialogTitle>
                ...
                <GridContainer>
                    <GridItem lg={6} md={6} sm={6} xs={6} style={{width:'500px'}}>
                    ...
                    <GridItem lg={6} md={6} sm={6} xs={6} style={{width:'600px'}}>
