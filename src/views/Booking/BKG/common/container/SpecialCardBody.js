...
const SpecialCardBody = (props) => {
  ...
  const {index, bookmarkYn, isCargoType} = props;
  useEffect(()=>{
      ...
      <GridContainer>
        ...
        <>
          <GridItem xs={11} sm={11}>
            <Typography variant='h6'>Danger Cargo Info</Typography>
          </GridItem>
          {/* <GridItem xs={1} sm={1}>
        ...
        <GridItem xs={6} sm={4}>
          <CustomInput
            ...
            inputProps={{
              ...
              disabled: ("Y"===bookmarkYn)?false:("3"===isCargoType )?false:true
            }}
            required={("Y"===bookmarkYn)?false:("3" === isCargoType )?special.special_undg?false:true:false}
            feedback="container"
          />
        </GridItem>
        <GridItem xs={6} sm={2} className={classes.gridLabel}>
        ...
        <GridItem xs={6} sm={4}>
          <CustomInput
            ...
            required={("Y"===bookmarkYn)?false:("3" === isCargoType )?special.special_imdg?false:true:false}
            feedback="container"
          />
        </GridItem>
