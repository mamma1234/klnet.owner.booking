...
function BookingBookmark(props) {
	...
	useEffect(() => {
		setBookmarkData({
			other_bookmark_name:store.sr.other_bookmark_name,
	...
	const onSaveBookmark =()=> {
		...
		if(bookmarkData && bookmarkData.other_bookmark_name !==null && bookmarkData.other_bookmark_name !=="") {
			axios.post("/shipper/setUserOthersBookmark",{user_no:props.userData?props.userData.user_no:'',data:bookmarkData},{}).then(res => {
	...
	const onBookMarkDelete = () => {
		if(bookmarkData && (!bookmarkData.other_bookmark_name || bookmarkData.other_bookmark_name ==="")) {
			...
			axios.post("/shipper/setUserOtherBookmarkDel",{user_no:props.userData?props.userData.user_no:'',data:bookmarkData},{}).then(res => {onInitData();
				props.reloadBookmark();
