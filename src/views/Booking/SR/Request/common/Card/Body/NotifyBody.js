						...
						<GridItem className={classes.grid} lg={9} md={9} sm={9} xs={12}>
							<CustomInput
								...
								inputProps={{
									...
									onBlur: (e)=>('B'===type || 'C'===type)?props.mergeNotiProps(notiBodyData):e.target.value && (e.target.value !== store.sr.noti_name1)?store.setSr({noti_name1:e.target.value}):store.setSr({noti_name1:''}),
									style:{height:'30px'}
								}}/>
						</GridItem>
					</GridContainer>
