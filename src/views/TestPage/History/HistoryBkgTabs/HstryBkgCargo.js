...
export default function HstryBkgCargo(props) {
  const url = ['/com/selectBkgCargo'];
      ...
      <TableContainer className={classes.tablecontainer}>
          ...
          <TableHead>
            <TableRow>
              ...
              <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">his_date             </TableCell>
              ...
              <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cargo_type               </TableCell>
              <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cargo_name               </TableCell>
              ...
              <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cargo_remark             </TableCell>
          ...
          <TableBody>
            {searchData.map((row,index) => (
                <TableRow className={classes.root} hover>
                    ...
                    <TableCell align="center">  {row.cargo_type           }    </TableCell>
                    ...
                    <TableCell align="center">  {row.cargo_remark         }    </TableCell>
            ...
            {searchData.length >= 10 
              ? Number(searchData[0].tot_page) !== pageNum 
                ? (
                  <TableFooter>
                    <TableRow>
                      <TableCell style={{textAlignLast:'center',paddingTop:'0',paddingBottom:'0'}} colSpan={40}>
                        <Button
                          style={{minWidth:'100%'}}
                          variant="contained"
                          color="info"
