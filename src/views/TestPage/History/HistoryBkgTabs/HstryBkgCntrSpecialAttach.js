...
export default function HstryBkgCntr(props) {
  const url = ['/com/selectBkgCntrSpecialAttach'];
          ...
          <Table 	 
            ...
            <TableHead>
              <TableRow>
                ...
                <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">attach_seq           </TableCell>                                   
                ...
                <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">attach_type          </TableCell>                                   
                <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">attach_absolute_path </TableCell>                                             
                <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">attach_physical_name </TableCell>                                             
                <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">attach_real_name     </TableCell>                                         
            ...
            <TableBody>
              {searchData.map((row,index) => (
                  <TableRow className={classes.root} hover>
                    ...
                    <TableCell align="center">{row.attach_seq           }</TableCell>                                   
                    ...
                    <TableCell align="center">{row.attach_type          }</TableCell>                                   
                    <TableCell align="center">{row.attach_absolute_path }</TableCell>                                             
                    <TableCell align="center">{row.attach_physical_name }</TableCell>                                             
                    <TableCell align="center">{row.attach_real_name     }</TableCell>                                         
              ...
              {searchData.length >= 10 
                ? Number(searchData[0].tot_page) !== pageNum 
                  ? (
                    <TableFooter>
                      <TableRow>
                        <TableCell style={{textAlignLast:'center',paddingTop:'0',paddingBottom:'0'}} colSpan={18}>
                          <Button
                           style={{minWidth:'100%'}}
                           variant="contained"
                            color="info"
