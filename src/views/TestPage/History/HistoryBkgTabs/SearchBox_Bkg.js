...
export default function SearchBox(props) {
  const { fromDate  ,toDate  ,setFromDate  ,setToDate  ,mode  ,userNo  ,setUserNo  
        ,bkgNo  ,setBkgNo  ,bkgDate  ,setBkgDate  ,ownerNo  ,setOwnerNo
        ,onSubmit  ,setMode} =props;
            ...
            <Grid container spacing={1}>
              ...
              <Grid item xs={12} sm={12} md={6}>
                <Grid container spacing={1}>
                  ...
                  <Grid item xs={6} sm={3} md={3} >
                    <TextField id="bkgNo" label="BKG NO" value={bkgNo} onChange={(e)=> setBkgNo(e.target.value)}  fullWidth/>
                  </Grid>	
                  <Grid item xs={6} sm={3} md={3} >
                    <TextField id="bkgDate" label="BKG DATE"  value={bkgDate} onChange={(e)=> setBkgDate(e.target.value)} fullWidth/>
                  </Grid>
                  <Grid item xs={6} sm={3} md={3} >
