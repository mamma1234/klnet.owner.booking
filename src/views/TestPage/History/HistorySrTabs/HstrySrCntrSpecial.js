...
export default function HstrySrCntrSpecial(props) {
  const url = ["/com/selectSrCntrSpecial"];
              ...
              {searchData.length >= 10 
                ? Number(searchData[0].tot_page) !== pageNum 
                  ? (
                    <TableFooter>
                      <TableRow>
                        <TableCell style={{textAlignLast:'center',paddingTop:'0',paddingBottom:'0'}} colSpan={70}>
                          <Button
                            style={{minWidth:'100%'}}
                            variant="contained"
                            color="info"
