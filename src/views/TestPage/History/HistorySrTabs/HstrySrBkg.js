          ...
          <Table 	 
            ...
            <TableHead>
                <TableRow>
                    ...
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">bkg_seq             </TableCell>                     
            ...
            <TableBody>
              {searchData.map((row,index) => (
                  <TableRow className={classes.root} hover>
                    ...
                    <TableCell align="center">{row.bkg_seq         }</TableCell>                     
