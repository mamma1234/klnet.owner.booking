...
export default function HstrySrCntr(props) {
  const url = ["/com/selectSrCntr"];
          ...
          <Table 	 
            ...
            <TableHead>
                <TableRow>
                    ...
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_no                  </TableCell>     
                    ...
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_truck_no            </TableCell>             
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_consolidated_yn     </TableCell>                 
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_total_weight        </TableCell>                 
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_total_volume        </TableCell>                 
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_carton_qty          </TableCell>             
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_weight              </TableCell>         
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_seal                </TableCell>         
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_export_license      </TableCell>                 
                    ...
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_carton_code         </TableCell>             
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_seal2               </TableCell>         
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_seal3               </TableCell>         
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_res_bkg_no          </TableCell>             
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cntr_auth_user_name      </TableCell>                 
                </TableRow>
            </TableHead>       
            <TableBody>
              {searchData.map((row,index) => (
                  <TableRow className={classes.root} hover>
                    ...
                    <TableCell align="center">{row.cntr_truck_no            }</TableCell>             
                    <TableCell align="center">{row.cntr_consolidated_yn     }</TableCell>                 
                    <TableCell align="center">{row.cntr_total_weight        }</TableCell>                 
                    <TableCell align="center">{row.cntr_total_volume        }</TableCell>                 
                    <TableCell align="center">{row.cntr_carton_qty          }</TableCell>             
                    <TableCell align="center">{row.cntr_weight              }</TableCell>         
                    <TableCell align="center">{row.cntr_seal                }</TableCell>         
                    <TableCell align="center">{row.cntr_export_license      }</TableCell>                 
                    <TableCell align="center">{row.cntr_soc_yn              }</TableCell>         
                    <TableCell align="center">{row.container_bookmark_seq   }</TableCell>                     
                    <TableCell align="center">{row.cntr_carton_code         }</TableCell>             
                    <TableCell align="center">{row.cntr_seal2               }</TableCell>         
                    <TableCell align="center">{row.cntr_seal3               }</TableCell>         
                    <TableCell align="center">{row.cntr_res_bkg_no          }</TableCell>             
                    <TableCell align="center">{row.cntr_auth_user_name      }</TableCell>
                  </TableRow>
              ))}
            </TableBody>
              {searchData.length >= 10 
                ? Number(searchData[0].tot_page) !== pageNum 
                  ? (
                    <TableFooter>
                      <TableRow>
                        <TableCell style={{textAlignLast:'center',paddingTop:'0',paddingBottom:'0'}} colSpan={61}>
                          <Button
                            style={{minWidth:'100%'}}
                            variant="contained"
                            color="info"
