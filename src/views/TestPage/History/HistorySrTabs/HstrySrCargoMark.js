...
export default function HstrySrCargoMark(props) {
  const url = ["/com/selectSrCargoMark"];
          ...
          <Table 	 
            ...
            <TableHead>
                <TableRow>
                    ...
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">mark_seq                  </TableCell>                   
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">mark_desc1                </TableCell>                       
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">mark_desc2                </TableCell>                       
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">mark_desc3                </TableCell>                       
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">mark_desc4                </TableCell>                       
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">mark_desc5                </TableCell>                       
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">mark_desc6                </TableCell>                       
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">mark_desc7                </TableCell>                       
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">mark_desc8                </TableCell>                       
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">mark_desc9                </TableCell>                       
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">mark_desc10               </TableCell>                       
                    <TableCell style={{borderBottomWidth:'3px',fontWeight:'bold',color:'#717172',borderBottom:'2px solid #00b1b7'}} align="center">cargo_mark_bookmark_seq   </TableCell> 
                </TableRow>
            </TableHead>       
            <TableBody>
              {searchData.map((row,index) => (
                  <TableRow className={classes.root} hover>
                    ...
                    <TableCell align="center">{row.mark_seq                }</TableCell>                   
                    <TableCell align="center">{row.mark_desc1              }</TableCell>                       
                    <TableCell align="center">{row.mark_desc2              }</TableCell>                       
                    <TableCell align="center">{row.mark_desc3              }</TableCell>                       
                    <TableCell align="center">{row.mark_desc4              }</TableCell>                       
                    <TableCell align="center">{row.mark_desc5              }</TableCell>                       
                    <TableCell align="center">{row.mark_desc6              }</TableCell>                       
                    <TableCell align="center">{row.mark_desc7              }</TableCell>                       
                    <TableCell align="center">{row.mark_desc8              }</TableCell>                       
                    <TableCell align="center">{row.mark_desc9              }</TableCell>                       
                    <TableCell align="center">{row.mark_desc10             }</TableCell>                       
                    <TableCell align="center">{row.cargo_mark_bookmark_seq }</TableCell> 
                  </TableRow>
              ))}
            </TableBody>
