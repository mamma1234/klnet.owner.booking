    	...
    	<Table className={classes.table}>
    		<TableHead className={classes[tableHeaderColor + "TableHeader"]}>
    	           <TableRow className={classes.tableHeadRow}>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >LINE<br/>CODE</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >VSL<br/>NAME</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >VOYAGE</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >START<br/>ROUTE<br/>DATE</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >START<br/>ROUTE<br/>CODE</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >END<br/>ROUTE<br/>DATE</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >END<br/>ROUTE<br/>CODE</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >START<br/>ROUTE<br/>NAME</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >END<br/>ROUTE<br/>NAME</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >ETA</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >ETA<br/>TIME</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >ETD</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >ETD<br/>TIME</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >TS_YN</TableCell>
    	                  <TableCell className={classes.tableCell + " " + classes.tableHeadCell} >INSERT<br/>DATE</TableCell>  
    	            </TableRow>
