      ...
      <TableRow key={this.props.index} className={this.staterowStyle} style={{borderCollapse:'separate',borderSpacing:'2px 2px',paddingTop:'5px'}} >
        ...
        <Tooltip title={data.line_code}>
            	<a target="_blank" rel="noopener noreferrer" href={data.line_url}  >
        			{(data.image_yn && data.img_line_code) === 'Y'?<img src={require("assets/img/carrier/"+data.img_line_code+".gif")} alt={data.line_code} />:<img src={require("assets/img/carrier/No-Image.gif")} alt={data.line_code}/>}
        		</a>
        	</Tooltip>
        ...
        <TableCell align="center" //onClick={this.cntrExpander} 
        style={{paddingTop:'0',paddingBottom:'0'}}>{data.current_terminal}</TableCell>
        <TableCell align="center" //onClick={this.cntrExpander} 
