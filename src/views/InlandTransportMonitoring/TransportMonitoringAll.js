...
import { Card,FormControl,TextField,Typography,CardHeader, Table,TableCell, TableBody, TableRow,TableHead,TableContainer,Tooltip} from "@material-ui/core";
...
export default function TransportMonitoringAll(props) {
    ...
    <div style={{paddingLeft:'3%',paddingRight:'3%'}}>
        <GridContainer justify="space-between" style={{marginBottom:'10px'}}>
            <GridItem md={8}>
                <GridContainer>
                    <GridItem xs={6} md={2}>
                        <TextField fullWidth id="shipperID" label="선사 CODE"/>
                    </GridItem>
                    <GridItem xs={6} md={2}>
                        <TextField fullWidth id="forwarderInfo" label="포워더"/>
                    </GridItem>
                    <GridItem xs={4} md={2}>
                        <TextField fullWidth id="blNo" label="B/L NO"/>
                    </GridItem>
                    <GridItem xs={4} md={3}>
                        <TextField fullWidth id="bkgNo" label="BOOKING NO"/>
                    </GridItem>
                    <GridItem xs={4} md={3}>
