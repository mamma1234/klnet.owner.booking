...
export default function ExpFfmnPridShrtTrgtPrlst(props) {
  ...
  const onSubmit = () => {
	  ...
	  if(props.userData) {
	    axios.post("/com/uniPassExpFfmnPridShrtTrgtPrlst",{param:param}, {headers:props.userData}).then(
	      res => {
  ...
  return (
    ...
    <Card>
        ...
        <Assignment />
          ...
          <h4 style={{textAlign: "left",color:"#000000", paddingTop:"10px"}}><b>수출이행기간 단축대상 품목</b></h4>
